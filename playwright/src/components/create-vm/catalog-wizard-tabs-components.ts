...
export class CreateVmWizardTabsComponent extends BaseComponent {
  ...
  readonly scripts: CreateVmWizardScriptsComponent;
  ...
  constructor(page: Page) {
    ...
    this.scripts = new CreateVmWizardScriptsComponent(page);
  }
  ...
  async navigateToWizardVerticalTab(
    ...
    const tabMapping: Record<string, string> = {
      ...
      Initial: 'vm-configuration-initial',
  ...
  async navigateToWizardScriptsTab(): Promise<void> {
    return this.scripts.navigateToWizardScriptsTab();
  }

  async verifySSHKeyEditButtonVisible(): Promise<boolean> {
    return this.scripts.verifySSHKeyEditButtonVisible();
  }

  async verifySSHKeyEditButtonDisabled(): Promise<boolean> {
    return this.scripts.verifySSHKeyEditButtonDisabled();
  }

  async verifySysprepEditButtonVisible(): Promise<boolean> {
    return this.scripts.verifySysprepEditButtonVisible();
  }

  async verifySysprepEditButtonEnabled(): Promise<boolean> {
    return this.scripts.verifySysprepEditButtonEnabled();
  }
  ...
  async fillWizardScripts(config: { sysprepName?: string }): Promise<void> {
    return this.scripts.fillWizardScripts(config);
  }

  async fillWizardSSH(secretName: string, sshKeyFilePath: string): Promise<void> {
    return this.scripts.fillWizardSSH(secretName, sshKeyFilePath);
  }
...
// ---------------------------------------------------------------------------
// CreateVmWizardDisksComponent (used internally by CreateVmWizardTabsComponent)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// CreateVmWizardScriptsComponent (used internally by CreateVmWizardTabsComponent)
// ---------------------------------------------------------------------------

export class CreateVmWizardScriptsComponent extends BaseComponent {
  ...
  private async navigateToWizardHorizontalTab(tabName: 'Scripts'): Promise<void> {
    await this.page.waitForTimeout(TestTimeouts.UI_DELAY_MEDIUM);
    const tabLocator = this.locator(`[data-test-id="horizontal-link-${tabName}"]`);
    await this.robustClick(tabLocator);
  }

...
test.describe('VM Creation Wizard (gating)', { tag: [GATING_TAG, '@catalog-wizard'] }, () => {
  test('New VM wizard creates a VM end-to-end without booting', async ({
    vmTreePage,
    ...
    await utils.withAllure({
      suite: SUITE,
      feature: GATING,
      tags: [GATING_TAG, 'e2e-create'],
    });

    await vmCreationWizardPage.navigateToWizardInNamespace(testConfig.testNamespace);

...
const TOUR_STEP_COUNTER_LOCATOR = '.kv-tour-popover__step-counter';
const TOUR_HEADER_LOCATOR = '.kv-tour-popover .kv-tour-popover__header';
const TOUR_NEXT_BUTTON_LOCATOR = '.kv-tour-popover button:has-text("Next")';
...
export const tourStepsTest = async (page: Page) => {
  ...
  const okayButton = page.locator('.kv-tour-popover button:has-text("Okay, got it!")');

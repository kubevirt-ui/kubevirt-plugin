...
export const hideGettingStartedCardKebab = 'button.pf-v5-c-menu-toggle.pf-m-plain';
...
export const popOverContent = '.pf-v5-c-popover__content';
export const closeBtn = '.pf-v5-c-popover__close';
...
export const cardTitleV5 = '.pf-v5-c-card__title';
...
export const switchInput = 'input.pf-v5-c-switch__input';
export const switchLabel = 'label.pf-v5-c-switch';

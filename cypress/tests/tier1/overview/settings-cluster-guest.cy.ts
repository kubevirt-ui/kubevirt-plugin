...
adminOnlyDescribe('Test Cluster Guest management', () => {
  ...
  xdescribe('Test auto subscription for RHEL guest', () => {
    ...
    it('ID(CNV-10321) fill Activation key for automatic subscription', () => {
      ...
      cy.wait(5000);
      cy.get('.pf-v6-c-form__group.subscription-label')
        .eq(1)
    ...
    it('ID(CNV-10321) verify Activation key on UI', () => {
    ...
    it('ID(CNV-10322) activation key is added to RHEL VM', () => {
      // cy.visitCatalog();

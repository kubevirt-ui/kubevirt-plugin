import { DEFAULT_VM_NAME, VM_IT_NAME, VM_TMPL_NAME } from '../../utils/const/index';
...
describe('Test VM actions on list page', () => {
  ...
  after(() => {
    cy.stopVM([DEFAULT_VM_NAME, VM_IT_NAME, VM_TMPL_NAME]);
  });
  ...
  // this test is easy to be a flaky
  xit('ID(CNV-8969) Test actions while VM is stopping', () => {
    cy.byLegacyTestID(vma.STOP).click();
    action.fstop(DEFAULT_VM_NAME);
  });
});

...
type StorageReadLatencyPerDriveChartProps = {
...
const StorageReadLatencyPerDriveChart: FC<StorageReadLatencyPerDriveChartProps> = ({ vmi }) => {
...
export default StorageReadLatencyPerDriveChart;

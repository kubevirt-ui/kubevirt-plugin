...
export const isRunStrategyStarting = (
  runStrategy: RunStrategy | undefined,
): runStrategy is RunStrategy =>
 ...
 * @param {RunStrategy | undefined} sourceRunStrategy the current effective run strategy
 */
 ...
 * @param {V1VirtualMachine['spec']} vmSpec the VM spec to migrate
 */
 ...
 * @param {V1VirtualMachine['spec']} vmSpec the VM spec to update
 * @param {RunStrategy} runStrategy the run strategy to apply
 */
 ...
 * @param {V1VirtualMachine} vm the source VM to derive current field state from
 * @param {RunStrategy} runStrategy the target run strategy
 */

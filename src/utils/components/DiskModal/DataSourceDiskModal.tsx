...
import DiskSourceDataSourceSelect from './components/DiskSourceSelect/components/DiskSourceDataSourceSelect/DiskSourceDataSourceSelect';
...
const DataSourceDiskModal: FC<V1DiskModalProps> = ({
  editDiskName,
  isCreated,
  isOpen,
  onClose,
  ...
  const methods = useForm<V1DiskFormState>({
    defaultValues: isEditDisk
      ...
      : getDefaultCreateValues(vm, SourceTypes.DATA_SOURCE),
    mode: 'all',
  });
    ...
    <FormProvider {...methods}>
      ...
      >
        ...
        <Form>
          ...
          <DiskNameInput />
          {!isCreated && <DiskSourceDataSourceSelect />}
...
export default DataSourceDiskModal;

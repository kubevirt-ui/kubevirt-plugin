/**
 * Converted to TypeScript from https://github.com/qemu/qemu/blob/b69801dd6b1eb4d107f7c2f643adf0a4e3ec9124/ui/vnc_keysym.h
 * modifications:
 * removed {NULL,0}
 */
export const name2keysym: [string, number][] = [
  /* ascii */
  ['space', 0x020],
  ['exclam', 0x021],
  ['quotedbl', 0x022],

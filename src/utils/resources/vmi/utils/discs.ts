import { type V1Disk, type V1VirtualMachineInstance } from '@kubevirt-ui-ext/kubevirt-api/kubevirt';
import { ROOTDISK } from '@kubevirt-utils/constants/constants';

export const getVMIBootDisk = (vmi: V1VirtualMachineInstance): V1Disk | { name: string } => {

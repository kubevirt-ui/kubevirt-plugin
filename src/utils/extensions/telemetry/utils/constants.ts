...
export const CANCEL_CREATE_VM_BUTTON_CLICKED = 'Cancel Create VM button clicked';
export const CREATE_VM_SUCCEEDED = 'Create VM succeeded';
export const CREATE_VM_FAILED = 'Create VM failed';
...
export const CUSTOMIZE_VM_SUCCEEDED = 'Customize VM succeeded';
export const CUSTOMIZE_VM_FAILED = 'Customize InstanceTypes VM flow failed';

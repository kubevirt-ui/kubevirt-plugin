...
const useUserPreferences = (namespace: string, fieldSelector?: string, selector?: Selector, cluster?: string): [V1beta1VirtualMachinePreference[], boolean, Error] => {

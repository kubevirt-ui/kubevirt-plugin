...
const ReadinessStep: FC<ReadinessStepProps> = ({ migrationPlan, vms }) => {
  const { t } = useKubevirtTranslation();
  const targetCluster = getTargetCluster(migrationPlan);
  ...
  } = useStorageReadiness(vms, targetCluster);
  ...
  const {
    ...
    networkMap,
    targetNADs,
  } = useNetworkReadiness(vms, targetCluster, getTargetNamespace(migrationPlan));

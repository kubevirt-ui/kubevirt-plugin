...
import { ALL_NAMESPACES_SESSION_KEY, ALL_NAMESPACES } from '@kubevirt-utils/hooks/constants';
...
const usePreferencesData: UsePreferencesData = (volumeListNamespace, preferencesData) => {
  const [userPreferencesData, userPreferencesLoaded] = useUserPreferences(
    volumeListNamespace === ALL_NAMESPACES ? ALL_NAMESPACES_SESSION_KEY : volumeListNamespace,
  );

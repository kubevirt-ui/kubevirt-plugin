...
type VirtualMachineSelectedVMActionButtonProps = {
  vms: V1VirtualMachine[];
};
const VirtualMachineSelectedVMActionButton: FC<VirtualMachineSelectedVMActionButtonProps> = ({
  vms,
}) => {
...
export default VirtualMachineSelectedVMActionButton;

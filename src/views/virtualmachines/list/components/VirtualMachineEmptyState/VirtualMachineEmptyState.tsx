...
import { NamespaceModel, VirtualMachineModel } from '@kubevirt-ui-ext/kubevirt-api/console';
...
const VirtualMachineEmptyState: FC<VirtualMachineEmptyStateProps> = ({ namespace }) => {
  ...
  const [canCreateNamespace, loadingNamespace] = useAccessReview({
    group: NamespaceModel.apiGroup,
    resource: NamespaceModel.plural,
    verb: 'create',
  });

  const loading = loadingVM || loadingNamespace;
            ...
            <>
              {canCreateVM ? (
                <div>
                  <Trans ns="plugin__kubevirt-plugin" t={t}>
                    Click <b>Create VirtualMachine</b> to get started, or right-click a namespace in
              ...
              {canCreateNamespace && (
                <div className="pf-v6-u-mt-md">
                  <Trans ns="plugin__kubevirt-plugin" t={t}>
                    <b>Don&apos;t have a namespace yet?</b> Right-click a cluster in the navigation

...
type UseNamespaceResourceQuotaResult = {
  loaded: boolean;
  loadError: unknown;
  namespaceQuota: NamespaceResourceQuota | undefined;
};

const useNamespaceResourceQuota = (namespace?: string): UseNamespaceResourceQuotaResult => {
  ...
  const namespaceQuota = useMemo<NamespaceResourceQuota | undefined>(() => {
    ...
    const result: NamespaceResourceQuota = {};
  ...
  return { loaded, loadError: loadError ?? null, namespaceQuota };
};

export default useNamespaceResourceQuota;

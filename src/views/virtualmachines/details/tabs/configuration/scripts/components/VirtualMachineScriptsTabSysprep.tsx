...
type VirtualMachineScriptsTabSysprepProps = {
  canUpdateVM: boolean;
  vm: V1VirtualMachine;
};
const VirtualMachineScriptsTabSysprep: FC<VirtualMachineScriptsTabSysprepProps> = ({
  canUpdateVM,
  vm,
}) => {
...
export default VirtualMachineScriptsTabSysprep;

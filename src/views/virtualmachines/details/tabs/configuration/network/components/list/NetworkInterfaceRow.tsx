...
import LinkStateDownIcon from '@kubevirt-utils/components/NetworkIcons/components/LinkStateDownIcon';
import LinkStateUpIcon from '@kubevirt-utils/components/NetworkIcons/components/LinkStateUpIcon';
...
import { getInterfaceState, isInterfaceEphemeral } from '../../utils/utils';
...
> = ({ activeColumnIDs, obj: { iface, network }, rowData: { isPending, vm } }) => {
  ...
  return (
    <>
      ...
      <TableData activeColumnIDs={activeColumnIDs} id="network">
        {getInterfaceState(vm, nicName) === NetworkInterfaceState.UP ? (
          <LinkStateUpIcon />
        ) : (
          <LinkStateDownIcon />
        )}

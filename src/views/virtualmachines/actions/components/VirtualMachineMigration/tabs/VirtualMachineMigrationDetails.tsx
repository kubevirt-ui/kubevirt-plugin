...
import { getDNS1123LabelError, sanitizeK8sResourceName } from '@kubevirt-utils/utils/validation';
...
const VirtualMachineMigrationDetails: FC<VirtualMachineMigrationDetailsProps> = ({
  ...
  const nameValidationError = getDNS1123LabelError(migrationPlanName);
  const nameValidated = nameValidationError ? ValidatedOptions.error : ValidatedOptions.default;
        ...
        <StackItem>
          ...
          >
            <TextInput
              ...
              isRequired
              onChange={(_, value) => setMigrationPlanName(sanitizeK8sResourceName(value))}
              validated={nameValidated}
              value={migrationPlanName}
            />
            {nameValidationError && (
              <FormGroupHelperText validated={ValidatedOptions.error}>
                {nameValidationError(t)}
              </FormGroupHelperText>
            )}
          </FormGroup>
        </StackItem>

...
export const getSearchTipsSections = (t: TFunction, isACMPage: boolean): SearchTipsSection[] => [
  {
    tips: [
      ...
      { description: t('CPU architecture'), query: 'arch:amd64' },
    ],
  ...
  {
    tips: [
      ...(isACMPage ? [{ description: t('Cluster'), query: 'cluster:local-cluster' }] : []),
  ...
  {
    tips: [
      { description: t('IP address'), query: 'ip:10.0.0' },
      { description: t('Network attachment'), query: 'network:default/my-network' },
    ],
    title: t('How is it connected?'),
  },
  {
    tips: [

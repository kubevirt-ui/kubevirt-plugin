...
import './WizardEnvironmentTabFooter.scss';

type WizardEnvironmentTabFooterProps = {
  error?: any;
...
const WizardEnvironmentTabFooter: React.FC<WizardEnvironmentTabFooterProps> = ({
  error,
  isSaveDisabled,
  onSave,
  onReload,
  ...
  return (
    <Stack className="wizard-environment-tab__buttons">
      <StackItem>
        {(error || apiError) && (
          <Alert
            isInline
...
export default WizardEnvironmentTabFooter;

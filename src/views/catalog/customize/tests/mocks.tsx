export const getMockTemplate = () => ({
  ...
  metadata: {
    ...
    annotations: {
      ...
      description:
        'Template for Red Hat Enterprise Linux 8.4 for SAP HANA workloads. Please consult the SAP HANA guide for node setup requirements.',
  ...
  parameters: [
    ...
    },
    {
      ...
      displayName:
        'The value of the kubevirt.io/workload node selector label key. The target node needs to match this label',

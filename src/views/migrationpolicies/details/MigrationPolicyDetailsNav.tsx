...
const MigrationPolicyDetailsNav: FC = () => {
  ...
  const [migrationPolicy] = useKubevirtWatchResource<V1alpha1MigrationPolicy>({
    cluster,
  ...
  return (
    <>
      <MigrationPolicyDetailsNavTitle mp={migrationPolicy} />
      <HorizontalNav pages={filteredPages} resource={migrationPolicy} />
    </>
  );
};

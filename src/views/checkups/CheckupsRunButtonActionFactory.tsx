...
import { SELF_VALIDATION_ACTION_MODE } from './self-validation/components/actions/CheckupsSelfValidationActionsUtils';
import { createSelfValidationAction } from './self-validation/components/actions/CheckupsSelfValidationSharedActionFactory';
...
export const CheckupsRunButtonActionFactory = {
  ...
  selfValidation: ({
    ...
    return createSelfValidationAction({
      isCreateSelfValidationPermitted,
      label: t('Self validation'),
      locationPath,
      mode: SELF_VALIDATION_ACTION_MODE.RUN,
      navigate,
      runningSelfValidationJobs,
    });
  },

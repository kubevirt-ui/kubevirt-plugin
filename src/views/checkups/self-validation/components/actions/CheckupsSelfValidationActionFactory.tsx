...
import { SELF_VALIDATION_ACTION_MODE } from './CheckupsSelfValidationActionsUtils';
import { createSelfValidationAction } from './CheckupsSelfValidationSharedActionFactory';
...
export const CheckupsSelfValidationActionFactory = {
  ...
  rerun: ({
    ...
    return createSelfValidationAction({
      ...
      jobs,
      label: t('Rerun'),
      mode: SELF_VALIDATION_ACTION_MODE.RERUN,
      otherRunningJobs,
    });
  },
};

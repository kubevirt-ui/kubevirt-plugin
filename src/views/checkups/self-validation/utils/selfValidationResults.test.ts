import { parseFailedTest } from './selfValidationResults';

describe('parseFailedTest', () => {
  describe('Multi-line YAML parsing', () => {
    it('should parse multi-line YAML with tags and description', () => {
...
should succeed pinging between two VMI/s in the same namespace`,
    ...
    it('should parse multi-line YAML with multiple tags and text after tags', () => {
...
should start in paused state if start strategy set to paused`,
    ...
    it('should parse multi-line YAML with tags separated by spaces', () => {
...
should allow regular network connection ipv4 with a specific port number`,
    ...
    it('should parse multi-line YAML with tags and immediate text after tags', () => {
...
has precisely the documented extra capabilities relative to a regular user pod`,
    ...
    it('should parse multi-line YAML with complex multi-line description', () => {

  ...
  return (
    <div className="overview__sidebar-pane-body resource-overview__body">
      ...
      <ResourceSummary resource={job} showPodSelector>
        <DetailsItem
          label={t('kubevirt-plugin~Desired completions')}
          obj={job}
          path="spec.completions"
        />
        <DetailsItem label={t('kubevirt-plugin~Parallelism')} obj={job} path="spec.parallelism" />
        <DetailsItem
          label={t('kubevirt-plugin~Active deadline seconds')}
          obj={job}

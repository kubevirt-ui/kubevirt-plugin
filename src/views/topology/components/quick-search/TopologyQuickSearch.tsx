  ...
  const quickSearchProviders: QuickSearchProviders = [
    {
      ...
      // t('kubevirt-plugin~View all developer catalog items ({{itemCount, number}})')
      catalogLinkLabel: 'kubevirt-plugin~View all developer catalog items ({{itemCount, number}})',
    ...
    },
    {
      ...
      // t('kubevirt-plugin~View all quick starts ({{itemCount, number}})'
      catalogLinkLabel: 'kubevirt-plugin~View all quick starts ({{itemCount, number}})',
      extensions: catalogService.catalogExtensions,
    },
    {
      catalogType: 'Samples',
      ...
      // t('kubevirt-plugin~View all samples ({{itemCount, number}})'
      catalogLinkLabel: 'kubevirt-plugin~View all samples ({{itemCount, number}})',
      extensions: catalogService.catalogExtensions,
    },
  ];
  return (
    <QuickSearchController
      ...
      searchPlaceholder={`${t('kubevirt-plugin~Add to Project')}...`}
      namespace={namespace}

...
import { useAddToProjectAccess } from '@console/dev-console/src/hooks/useAddToProjectAccess';
...
import { getEventSourceStatus } from '@console/knative-plugin/src/topology/knative-topology-hooks';
                    ...
                    {canDrop && isOver && (
                      ...
                      >
                        <span className="co-file-dropzone__drop-text odc-topology__dropzone-text">
                          {t('kubevirt-plugin~Drop file ({{fileTypes}}) here', { fileTypes })}
                        </span>
                      </div>
                    )}
                    {nodesLength > MAX_NODES_LIMIT && !showTopologyAnyway ? (

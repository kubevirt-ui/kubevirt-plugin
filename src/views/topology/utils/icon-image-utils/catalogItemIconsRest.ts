...
export const catalogItemIconsRest: [string, string][] = [
  ['icon-mariadb', toCatalogIconSrc(mariadbImg)],
  ['icon-mediawiki', toCatalogIconSrc(mediawikiImg)],
  ['icon-memcached', toCatalogIconSrc(memcachedImg)],
  ['icon-mongodb', toCatalogIconSrc(mongodbImg)],
  ['icon-mssql', toCatalogIconSrc(mssqlImg)],
  ['icon-mysql-database', toCatalogIconSrc(mysqlDatabaseImg)],
  ['icon-nginx', toCatalogIconSrc(nginxImg)],
  ['icon-nodejs', toCatalogIconSrc(nodejsImg)],
  ['icon-openjdk', toCatalogIconSrc(openjdkImg)],
  ['icon-openliberty', toCatalogIconSrc(openlibertyImg)],
  ['icon-openshift', toCatalogIconSrc(openshiftImg)],
  ['icon-openstack', toCatalogIconSrc(openstackImg)],
  ['icon-operator', toCatalogIconSrc(operatorImg)],
  ['icon-other-linux', toCatalogIconSrc(otherLinuxImg)],
  ['icon-other-unknown', toCatalogIconSrc(otherUnknownImg)],
  ['icon-perl', toCatalogIconSrc(perlImg)],
  ['icon-phalcon', toCatalogIconSrc(phalconImg)],
  ['icon-php', toCatalogIconSrc(phpImg)],
  ['icon-play', toCatalogIconSrc(playImg)],
  ['icon-postgresql', toCatalogIconSrc(postgresqlImg)],
  ['icon-processserver', toCatalogIconSrc(processserverImg)],
  ['icon-python', toCatalogIconSrc(pythonImg)],
  ['icon-quarkus', toCatalogIconSrc(quarkusImg)],
  ['icon-rabbitmq', toCatalogIconSrc(rabbitmqImg)],
  ['icon-rails', toCatalogIconSrc(railsImg)],
  ['icon-react', toCatalogIconSrc(reactImg)],
  ['icon-redhat', toCatalogIconSrc(redhatImg)],
  ['icon-redis', toCatalogIconSrc(redisImg)],
  ['icon-rh-integration', toCatalogIconSrc(rhIntegrationImg)],
  ['icon-rh-openjdk', toCatalogIconSrc(openjdkImg)],
  ['icon-rh-spring-boot', toCatalogIconSrc(rhSpringBoot)],
  ['icon-rh-tomcat', toCatalogIconSrc(rhTomcatImg)],
  ['icon-ruby', toCatalogIconSrc(rubyImg)],
  ['icon-rust', toCatalogIconSrc(rustImg)],
  ['icon-scala', toCatalogIconSrc(scalaImg)],
  ['icon-serverless-function', toCatalogIconSrc(serverlessFuncImage)],
  ['icon-shadowman', toCatalogIconSrc(shadowmanImg)],
  ['icon-spring-boot', toCatalogIconSrc(springBootImg)],
  ['icon-spring', toCatalogIconSrc(springImg)],
  ['icon-sso', toCatalogIconSrc(ssoImg)],
  ['icon-stackoverflow', toCatalogIconSrc(stackoverflowImg)],
  ['icon-suse', toCatalogIconSrc(suseImg)],
  ['icon-symfony', toCatalogIconSrc(symfonyImg)],
  ['icon-tomcat', toCatalogIconSrc(tomcatImg)],
  ['icon-ubuntu', toCatalogIconSrc(ubuntuImg)],
  ['icon-vertx', toCatalogIconSrc(vertxImg)],
  ['icon-vscode', toCatalogIconSrc(vscodeImg)],
  ['icon-wildfly', toCatalogIconSrc(wildflyImg)],
  ['icon-windows', toCatalogIconSrc(windowsImg)],
  ['icon-wordpress', toCatalogIconSrc(wordpressImg)],
  ['icon-xamarin', toCatalogIconSrc(xamarinImg)],
  ['icon-zend', toCatalogIconSrc(zendImg)],
];

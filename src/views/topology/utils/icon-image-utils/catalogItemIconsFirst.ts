...
export const catalogItemIconsFirst: [string, string][] = [
  ['icon-3scale', toCatalogIconSrc(threeScaleImg)],
  ['icon-aerogear', toCatalogIconSrc(aerogearImg)],
  ['icon-amq', toCatalogIconSrc(amqImg)],
  ['icon-angularjs', toCatalogIconSrc(angularjsImg)],
  ['icon-ansible', toCatalogIconSrc(ansibleImg)],
  ['icon-apache', toCatalogIconSrc(apacheImg)],
  ['icon-beaker', toCatalogIconSrc(beakerImg)],
  ['icon-build', toCatalogIconSrc(buildIconImg)],
  ['icon-camel', toCatalogIconSrc(camelImg)],
  ['icon-capedwarf', toCatalogIconSrc(capedwarfImg)],
  ['icon-cassandra', toCatalogIconSrc(cassandraImg)],
  ['icon-catalog', toCatalogIconSrc(catalogImg)],
  ['icon-clojure', toCatalogIconSrc(clojureImg)],
  ['icon-codeigniter', toCatalogIconSrc(codeigniterImg)],
  ['icon-cordova', toCatalogIconSrc(cordovaImg)],
  ['icon-datagrid', toCatalogIconSrc(datagridImg)],
  ['icon-datavirt', toCatalogIconSrc(datavirtImg)],
  ['icon-debian', toCatalogIconSrc(debianImg)],
  ['icon-decisionserver', toCatalogIconSrc(decisionserverImg)],
  ['icon-django', toCatalogIconSrc(djangoImg)],
  ['icon-dotnet', toCatalogIconSrc(dotnetImg)],
  ['icon-drupal', toCatalogIconSrc(drupalImg)],
  ['icon-eap', toCatalogIconSrc(eapImg)],
  ['icon-elastic', toCatalogIconSrc(elasticImg)],
  ['icon-erlang', toCatalogIconSrc(erlangImg)],
  ['icon-fedora', toCatalogIconSrc(fedoraImg)],
  ['icon-freebsd', toCatalogIconSrc(freebsdImg)],
  ['icon-git', toCatalogIconSrc(gitImg)],
  ['icon-gitea', toCatalogIconSrc(giteaImg)],
  ['icon-github', toCatalogIconSrc(githubImg)],
  ['icon-gitlab', toCatalogIconSrc(gitlabImg)],
  ['icon-glassfish', toCatalogIconSrc(glassfishImg)],
  ['icon-go-gopher', toCatalogIconSrc(goGopherImg)],
  ['icon-golang', toCatalogIconSrc(goLangImg)],
  ['icon-grails', toCatalogIconSrc(grailsImg)],
  ['icon-hadoop', toCatalogIconSrc(hadoopImg)],
  ['icon-haproxy', toCatalogIconSrc(haproxyImg)],
  ['icon-helm', toCatalogIconSrc(helmImg)],
  ['icon-httpd', toCatalogIconSrc(apacheImg)],
  ['icon-infinispan', toCatalogIconSrc(infinispanImg)],
  ['icon-intellij', toCatalogIconSrc(intellijImg)],
  ['icon-java', toCatalogIconSrc(openjdkImg)],
  ['icon-jboss', toCatalogIconSrc(jbossImg)],
  ['icon-jenkins', toCatalogIconSrc(jenkinsImg)],
  ['icon-jetty', toCatalogIconSrc(jettyImg)],
  ['icon-joomla', toCatalogIconSrc(joomlaImg)],
  ['icon-jruby', toCatalogIconSrc(jrubyImg)],
  ['icon-js', toCatalogIconSrc(jsImg)],
  ['icon-knative', toCatalogIconSrc(knativeImg)],
  ['icon-kubevirt', toCatalogIconSrc(kubevirtImg)],
  ['icon-laravel', toCatalogIconSrc(laravelImg)],
  ['icon-load-balancer', toCatalogIconSrc(loadBalancerImg)],
];

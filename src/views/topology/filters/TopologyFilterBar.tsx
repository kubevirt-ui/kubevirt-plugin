...
import { ExternalLink, setQueryArgument } from '@console/internal/components/hooks';
        ...
        <ToolbarGroup variant={ToolbarGroupVariant['filter-group']}>
          <ToolbarItem>
            <ToolbarFilter
              ...
              categoryName={t('kubevirt-plugin~Label')}
            >
              <ToolbarFilter
                chips={searchQuery.length > 0 ? [searchQuery] : []}
                deleteChip={clearNameFilter}
                categoryName={t('kubevirt-plugin~Name')}
              >
          ...
          {viewType === TopologyViewType.graph ? (
            <ToolbarItem>
              <Popover
                aria-label={t('kubevirt-plugin~Find by name')}
                position="left"
                bodyContent={
                  <Trans ns="topology">
        ...
        >
          ...
          {kialiLink && (
            <ToolbarItem className="odc-topology-filter-bar__kiali-link1">
              <ExternalLink href={kialiLink} text={t('kubevirt-plugin~Kiali')} />
            </ToolbarItem>
          )}

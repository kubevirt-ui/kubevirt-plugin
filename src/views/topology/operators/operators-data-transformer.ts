...
import { isOperatorBackedKnResource } from '@console/knative-plugin/src/topology/knative-topology-hooks';
import {
  getOperatorBackedServiceKindMap,
  isOperatorBackedService,
} from '@console/shared/src/hooks/operator-hooks';
import { EdgeModel, Model } from '@patternfly/react-topology/dist/esm/types';

import { ClusterServiceVersionKind, K8sResourceKind } from '../../clusteroverview/utils/types';
...
import { TopologyDataResources } from '../utils/types/topology-types';

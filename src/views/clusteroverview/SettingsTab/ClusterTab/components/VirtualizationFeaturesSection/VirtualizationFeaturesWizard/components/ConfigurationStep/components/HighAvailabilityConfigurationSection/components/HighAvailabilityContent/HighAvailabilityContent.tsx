...
import HAInstallStatusMessage from '@overview/SettingsTab/ClusterTab/components/VirtualizationFeaturesSection/VirtualizationFeaturesWizard/components/ConfigurationStep/components/HighAvailabilityConfigurationSection/components/HighAvailabilityContent/HAInstallStatusMessage';
import HighAvailabilityFeatureItem from '@overview/SettingsTab/ClusterTab/components/VirtualizationFeaturesSection/VirtualizationFeaturesWizard/components/ConfigurationStep/components/HighAvailabilityConfigurationSection/components/HighAvailabilityContent/HighAvailabilityFeatureItem';
...
const HighAvailabilityContent: FC<HighAvailabilitySectionProps> = ({
  ...
  return (
    <Stack className="high-availability-section-content" hasGutter>
      <StackItem className="high-availability-section-content__install-status-message">

...
import { installStateIconAndMessage } from '@overview/SettingsTab/ClusterTab/components/VirtualizationFeaturesSection/VirtualizationFeaturesWizard/components/SummaryStep/utils/utils';
...
const SummaryStatusIcon: FC<SummaryStatusIconProps> = ({
  ...
  const { Icon, message } = installState
    ? installStateIconAndMessage[installState]
    : { Icon: UnknownIcon, message: 'Unknown status' };

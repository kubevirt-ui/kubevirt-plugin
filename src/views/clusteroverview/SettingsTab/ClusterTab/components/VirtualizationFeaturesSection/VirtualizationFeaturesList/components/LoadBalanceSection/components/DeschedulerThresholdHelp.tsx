    ...
    <HelpTextIcon
      bodyContent={
        <Content>
          ...
          <p>
            {t(
              'E.g. 0%:10% means mark every Node with utilization below average as underutilized. And every Node with utilization more than 10% above average as overutilized.',
            )}
          </p>
        </Content>
      }

...
const BootableVolumesList: FC = () => {
  ...
  const [data, filteredData, onFilterChange] = useListPageFilter(bootableVolumes, [...filtersWithSelect, ...rowFilters]);
  ...
  if (loaded && isEmpty(bootableVolumes) && isEmpty(filteredClusters) && isEmpty(filteredNamespaces)) {

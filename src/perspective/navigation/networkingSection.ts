import { type NavSection, type ResourceNSNavItem } from '@openshift-console/dynamic-plugin-sdk';
...
import { extraNetworkingNavItems } from './networkingSectionItems';
